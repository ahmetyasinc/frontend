...
import { IoMdSearch } from "react-icons/io"; // Arama ikonu
...
import FavoriteIndicators from "../(modal_tabs)/favoriteIndicator";
...
const IndicatorsButton = () => {
  ...
  return (
    <>
      {/* Buton */}
      <button
        className="flex items-center justify-center w-[130px] h-[40px] rounded-md transition-all duration-200 bg-gray-800 hover:bg-gray-700 text-white"
